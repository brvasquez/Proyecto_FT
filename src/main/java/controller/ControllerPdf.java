...
public class ControllerPdf extends HttpServlet {
    ...
    public static final String lIST_STUDENT = "views/Pagina1.jsp";
    public static final String INSERT_OR_EDIT = "views/Pagina2.jsp";
    public static final String INSERT_OR_EDIT2 = "views/Pagina3.jsp";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        sql auto = new sql();
        int nuevoid = auto.auto_increm("SELECT MAX(codigopdf) FROM materialapoyo;");
        ...
        RequestDispatcher view = request.getRequestDispatcher("views/Pagina1.jsp");
        view.forward(request, response);
    }
