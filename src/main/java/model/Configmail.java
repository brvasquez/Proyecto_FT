...
public class Configmail {
	...
	public static void enviarCorreo(String host, String puerto, final String remitente, final String password,
			String destinatario, String asunto, String cuerpo) throws AddressException, MessagingException {
